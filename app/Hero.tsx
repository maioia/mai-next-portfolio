    ...
    <>
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          ...
          />
          <p className="text-center md:tracking-wider mb-4text-sm md:text-lg lg:text-2xl">
            I&apos;m mai. I&apos;m an Experienced Frontend Developer
            specializing in SPA web applications.
          </p>

          <a href="#about">
            <Mgbutton title="Show my work" />
          </a>
        </div>
      </div>
    </>
